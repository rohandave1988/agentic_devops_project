...
class Agent:
    ...
    def _run_cycle(self):
        ...
        with agent_span("agent.cycle", **{"cycle.number": self.cycle}) as cycle_sp:
            ...
            # ── 3. REASON — multi-agent investigation ────────────────────────
            ...
            # ── 6. ACT ───────────────────────────────────────────────────────
            # patch_code needs diagnosis context — inject before execution.
            ...
            if action_taken and not config.DRY_RUN:
                ...
                # Pass orchestrator + root_cause so the outcome feeds back into agent memory.
                threading.Thread(
